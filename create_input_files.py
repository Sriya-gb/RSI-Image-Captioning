...
if __name__ == '__main__':
    ...
    parser.add_argument('--karpathy_json_path', default="D:\__MAJOR__\Code\MLAT\RSICD_captions\dataset_rsicd.json",help='path of captions dataset.')
    parser.add_argument('--image_folder', default="D:\__MAJOR__\Code\MLAT\RSICD_captions\images", help='path of image dataset.')
    ...
    parser.add_argument('--output_folder', default='D:\__MAJOR__\Code\MLAT\RSICD_captions\data', help='output filepath.')
